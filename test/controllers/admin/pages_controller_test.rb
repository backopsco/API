...
class Admin::PagesControllerTest < ActionController::TestCase
  ...
  test "should create admin_page" do
    assert_difference('Admin::Page.count') do
      post :create, admin_page: { edit: @admin_page.edit, index: @admin_page.index, new: @admin_page.new, show: @admin_page.show }
    end
  ...
  test "should update admin_page" do
    patch :update, id: @admin_page, admin_page: { edit: @admin_page.edit, index: @admin_page.index, new: @admin_page.new, show: @admin_page.show }
    assert_redirected_to admin_page_path(assigns(:admin_page))
  end
